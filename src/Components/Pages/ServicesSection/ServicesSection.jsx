  ...
  const services = [
    {
      ...
      subtitle: 'DRESS, 2023',
      description: '65% General practitioners are no longer accepting patients as primary care physicians.'
    },
    {
      ...
      description: '45% French people have forgone at least one treatment in 2024 due to excessively high fees.'
    },
    {
      ...
      description: '€27,000 per employee / year lost to absenteeism and decreased productivity.'
    }
  ];
    ...
    <section className="healthcare-section">
      <Container>
        <div className="section-header">
          <h2 className="section-title">The healthcare system is on the verge of collapse.</h2>
          <p className="section-subtitle">Medical deserts, exorbitant consultation fees, insufficient prevention… Your employees are finding it increasingly difficult to take care of themselves, and this is costing your company dearly.</p>
        </div>
